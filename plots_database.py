...
def plot_distribution(coords, dcoords, namefile, name):
    ...
    for j in range(n_inputs):
        ...
        ax.set_xlabel(title[j], fontsize = 15)
        ax.set_ylabel("Frequency", fontsize = 15)
        ax.set_xticklabels(trunc(ax.get_xticks(), decs = 2),  fontsize=13)
    ...
    for j in range(n_outputs):
        ...
        ax.set_xticklabels(ax.get_xticks() ,rotation = 45, fontsize = 13)
        ax.set_yticklabels(ax.get_yticks(), fontsize = 13)
        # ax.set_yscale("symlog",linthresh=1.e-6)
        ax.set_xlabel(title_o[j], fontsize = 15)
        ax.set_ylabel("Frequency", fontsize = 15)
